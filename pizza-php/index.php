...
<body style="font-family: 'Montserrat'; scroll-behavior: smooth;">
  ...
  <div class="content" id="content">
    ...
    <div class="flex">
      <div>
        <h1 class="text-8xl ml-24 mt-20 font-bold">Craving for Pizzas?</h1>
        <button class="bg-[#ff4c68] rounded-xl text-xl font-bold h-16 w-40 ml-24 p-5 mt-4 inline-flex items-center
         hover:scale-110"><a href="menu.php">Order Now</a></button>
      </div>
      <img src="./images/10219-removebg.png" class="w-2/4 -mt-14">
    </div>
    ...
    <div class="bg-[#ff4c68]">
      ...
      <div class="flex justify-around">
        <div class="text-white font-bold">
          <img src="./images/smartphone.png" class="w-52 ml-8 hover:scale-110">
          <p class="text-3xl p-4">Easy To Order</p>
        </div>

        <div class="text-white font-bold">
          <img src="./images/delivery.png" class="w-52 hover:scale-110">
          <p class="text-3xl p-4">Fast Delivery</p>
        </div>

        <div class="text-white font-bold">
          <img src="./images/dinner.png" class="w-52 hover:scale-110">
          ...
          <div class="right w-1/3">
            <form action="" method="get">
              ...
              <div class="mt-8">
                ...
                <!-- <button
                class="uppercase text-sm font-bold tracking-wide bg-indigo-500 text-gray-100 p-3 rounded-lg w-full">
                Send Message
              </button> -->
              </div>
            </form>
