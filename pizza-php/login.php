    ...
    if (isset($_POST['logbtn']) == 'Log in') {
        ...
        if ($username == '' || $password == '') {
            ...
            if (strlen($password) < 8) {
                ...
                $err_msg = '';
                // $stmt = $con->prepare("SELECT * FROM customertb WHERE name=? AND password=?");
                /*
                i - integer
d - double
s - string
b - BLOB
               ...
               /* $stmt->bind_param('ss',$username,$password);
                ...
                $qry="SELECT * FROM customertb WHERE name='$username'";
                $stmt=$con->query($qry);
            ...
            <div class="mt-5">
                <form action="" method="POST">
                    <div class="flex flex-col mb-6">
                        ...
                        <div class="relative">
                            <input id="email" type="text" name="txtusername"
